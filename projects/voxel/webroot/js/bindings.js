 ...
 * Menu
 ******************************************************************************/
const menuOptions = ["map", "files", "controls", "settings"];
let openedMenu = "map";
...
function changeMapShape(val) {
    _map.shape = val;
}
function changeFade(name) {
    switch (name) {
        case "none":
            settings.fade = noFade;
            break;
        case "linear":
            settings.fade = linearFade;
            break;
        case "linear_delayed":
            settings.fade = linearDelayedFade;
            break;
        case "exponential":
            settings.fade = exponentialFade;
            break;
...
function changeBackground(name) {
    switch (name) {
        case "monochrome":
            settings.background = monochromeBackground;
            break;
        case "sun_line":
            settings.background = sunLineBackground;
            break;
        case "sun_point":
            settings.background = sunPointBackground;
            break;
    }
}
function changeLOD(val) {
 ...
 * Map selection
 ******************************************************************************/
async function loadMap(filenames) {
...
function imagesToMapData(colorData, heightData, name) {
 ...
 * Goxel file handling
 ******************************************************************************/
async function uploadGoxel(file) {
    // X Y Z RRGGBB
