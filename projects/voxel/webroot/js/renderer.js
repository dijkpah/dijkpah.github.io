...
const DEFAULT_BACKGROUND_COLOR = "#9090E0";
...
function setMap({ altitudes, colors, background, sun, dimension, name, shape }, cameraPosition) {
...
// Viewer information ----------------------------------------------------------
let camera = {
    x: 700, // x position on the map
    y: 700, // y position on the map
    angle: 1.75 * Math.PI, // direction of the camera
    height: 400, // height of the camera
    horizon: HORIZON_HORIZONTAL, // horizon position (look up and down), number of pixels on canvas from top of screen
 ...
 ******************************************************************************/
function noFade(_z) { return 255; }
;
function linearFade(z) { return 255 - 255 * z / settings.renderDistance; }
;
function linearDelayedFade(z) {
